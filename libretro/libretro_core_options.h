...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "Lightgun X Ratio",
      NULL,
      "Set the ratio of the X-axis of the Lightgun.",
      NULL,
      "input",
      {
         { "1.00",  NULL },
   ...
   },
   {
      ...
      "Lightgun Y Ratio",
      NULL,
      "Set the ratio of the Y-axis of the Lightgun.",
      NULL,
      "input",
      {
         { "1.00",  NULL },
   ...
   },
   {
      ...
      "Lightgun X Offset",
      NULL,
      "Set the offset of the X-axis of the Lightgun.",
      NULL,
      "input",
      {
         { "-75.0",  NULL },
   ...
   },
   {
      ...
      "Lightgun Y Offset",
      NULL,
      "Set the offset of the Y-axis of the Lightgun.",
      NULL,
      "input",
      {
         { "-75.0",  NULL },
   ...
   },
   {
      ...
      NULL,
      "Inverts the Y-axis of the left stick of the Lightgun input device type.",
      NULL,
      "input",
      {
         { "disabled", NULL },
