...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "genesis_plus_gx_msp_x_ratio",
      "MS Paddle Ratio.",
      NULL,
      "Set the ratio of the MS Paddle Controller input device type.",
      NULL,
      "input",
      {
         { "0.50",  NULL },
   ...
   {
      "genesis_plus_gx_msp_x_offset",
      "MS Paddle Offset.",
      NULL,
      "Set the offset of the MS Paddle Controller input device type.",
      NULL,
      "input",
      {
         { "-50.0",  NULL },
